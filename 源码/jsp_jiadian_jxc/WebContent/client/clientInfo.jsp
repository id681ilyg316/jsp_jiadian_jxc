		    ...
		    <ul class="nav">
		    	<li class="dropdown">
                       ...
                       <ul class="dropdown-menu">
                         ...
                         <li><a href="stock!list">家电信息维护</a></li>
                         <li><a href="stock!chaxun">家电信息查询</a></li>
                       </ul>
                   </li>
		      	<li class="dropdown">
...
<form action="${pageContext.request.contextPath}/client!chaxun" method="post">
			<table align="center" style="margin-top: 20px;">
				<tr>
					<td><lable>姓名：</lable></td>
					<td><input type="text" id="" name="clientName" value="${client.clientName }" style="height: 30px;"/></td>
					 
					<td><input type="submit" class="btn btn-primary" value="查询" style="margin: 5px; h"/></td>
				</tr>		
			</table>
		</form>
